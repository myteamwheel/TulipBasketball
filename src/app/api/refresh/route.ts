...
import { DYNASTY_DEALER_REFRESH_ENABLED, KTC_DIRECT_REFRESH_ENABLED, MARKET_SOURCE_MAX_AGE_HOURS, STATSGUY_REFRESH_ENABLED } from "@/lib/config";
...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    capabilities: {
      ...
      sources: { KTC: KTC_DIRECT_REFRESH_ENABLED, DYNASTY_DEALER: DYNASTY_DEALER_REFRESH_ENABLED, STATSGUY: STATSGUY_REFRESH_ENABLED },
