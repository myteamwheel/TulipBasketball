...
export default async function PlayersPage() {
  ...
  return <div className="min-w-0 space-y-6"><div><h1 className="text-xl font-semibold text-neutral-100">League Players</h1><p className="mt-1 text-sm text-neutral-500">Every currently rostered player in Dynasty Bois. Signals shown here are from each current owner&apos;s perspective.</p></div><PlayerTable rows={rows} showOwner /></div>;
}
