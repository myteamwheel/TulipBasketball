...
type SortKey = "fullName" | "position" | "currentValue" | "consensusValue" | "change7dPoints" | "change30dPoints" | "changeBaselinePoints";
    ...
    <div className="border-b border-neutral-800 p-3">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-2 sm:flex-row">
          <input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search players…" className="h-9 w-full rounded-md border border-neutral-700 bg-neutral-950 px-3 text-xs text-neutral-100 sm:w-56"/>
