...
export const CONSENSUS_WEIGHTS = { KTC: 0.6, TRADYR: 0.2, DYNASTY_DEALER: 0.2 } as const;
...
export const STARTING_REQUIREMENTS = { QB: 1, RB: 2, WR: 2, TE: 1, FLEX: 3, SUPERFLEX: 1 } as const;
